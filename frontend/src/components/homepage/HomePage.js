...
import { APP_DESC, APP_NAME } from "../../utils/constants/Constants";
...
function HomePage() {
    ...
    const goToAuthority = () => {
        navigate("authority/sign");
    }

    const CHECKLIST_ITEMS = [
        "Creating Environmental Friendly Documents",
        "e-signature proofs on Blockchain",
            ...
            <Row gutter={16}>
                ...
                <Col span={8}>
                    <Card
                        ...
                        actions={[
                            <Button type="primary" size="large" onClick={goToUser}>
                                Login as User
                            </Button>
                        ]}
                    >
                ...
                <Col span={8}>
                    <Card
                        ...
                        actions={[
                            <Button type="primary" size="large" onClick={goToAuthority}>
                                Login as Authority
                            </Button>
                        ]}
                    >
